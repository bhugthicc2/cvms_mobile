...
class ScanEntrancePage extends StatefulWidget {
  const ScanEntrancePage({super.key});

  @override
  State<ScanEntrancePage> createState() => _ScanEntrancePageState();
}

class _ScanEntrancePageState extends State<ScanEntrancePage> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Stack(
          children: [
            // Blurred/tinted overlay with a clear cutout in the middle
            ClipPath(
